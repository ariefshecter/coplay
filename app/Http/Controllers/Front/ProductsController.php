            ...
            if (isset($_REQUEST['search']) && !empty($_REQUEST['search'])) { // If the Search Form is used, handle the Search Form submission
                ...
                if ($_REQUEST['search'] == 'new-arrivals') {
                    ...
                    $categoryProducts = Product::select(
                        'products.id', 'products.section_id', 'products.category_id', 'products.brand_id', 'products.vendor_id', 'products.product_name', 'products.product_code', 'products.product_price',  'products.product_discount', 'products.product_image', 'products.description'
                ...
                // Discount    // Check front/layout/header.blade.php    
                    ...
                    $categoryProducts = Product::select(
                        ...
                        // We'll search for the searched term by the user in the `product_name`, `product_code`, `` and `description` columns in the `products` table and in the `category_name` column in the `categories` table
